...
let myPenguin = {
    personaje: 'Pingo',
    origen: 'Rasmus Klump',
    creador: 'Carla y Vilhelm Hansen',
    nota: 'Uno de los mejores amigos de Rasmus'
}
...
console.log(`Hola, soy un pingüino y mi nombre es ${myPenguin.personaje}`)
...
myPenguin.saludar = function(){
    return `Hola, soy un pingüino y mi nombre es ${this.personaje}`
}
...
myPenguin.personaje = 'Señor Pingu'
